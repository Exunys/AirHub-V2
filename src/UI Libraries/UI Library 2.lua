-- Bracket V3 by AlexR32 (Edited by Exunys for AirHub V2)
	...
	function WindowInit:CreateTab(Name)
		...
		function TabInit:CreateSection(Name)
			...
			function SectionInit:CreateSlider(AIRHUBCONFIG)
				local Name, Min, Max, Default, Precise, Callback = AIRHUBCONFIG.Name, AIRHUBCONFIG.Min, AIRHUBCONFIG.Max, AIRHUBCONFIG.Default, false, AIRHUBCONFIG.Callback
			...
			function SectionInit:CreateDropdown(AIRHUBCONFIG)
				local Name, OptionTable, Callback, InitialValue = AIRHUBCONFIG.Name, AIRHUBCONFIG.Content, AIRHUBCONFIG.Callback, AIRHUBCONFIG.Default
				local DropdownInit = {}
